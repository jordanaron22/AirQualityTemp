...
ImputedDensity <- function(patient_exposure_test_full,patient_exposure_test_med,pat_exp_bool,lag){
  ...
  plot(density(y),main = paste0("Original vs Imputed Density for Armean ",lag_to_print))
...
ImputedDensity(patient_exposure_test_full,patient_exposure_test_med,pat_exp_bool,1)
ImputedDensity(patient_exposure_test_full,patient_exposure_test_med,pat_exp_bool,2)
ImputedDensity(patient_exposure_test_full,patient_exposure_test_med,pat_exp_bool,3)
ImputedDensity(patient_exposure_test_full,patient_exposure_test_med,pat_exp_bool,4)
ImputedDensity(patient_exposure_test_full,patient_exposure_test_med,pat_exp_bool,5)

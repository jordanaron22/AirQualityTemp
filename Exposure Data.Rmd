...
SimulateMetroData <- function(States,City,samp_size){
  ...
  metro_tracts <- map_dfr(States,progress_bar=F, ~{
...
patient_exposure_2018$person <- patient_exposure_2018$person + max(patient_exposure_2019$person)

patient_exposure <- rbind(patient_exposure_2019,patient_exposure_2018)
